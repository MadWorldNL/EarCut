...
public class EarCutTests
{
    ...
    {
        var triangles = Logic.EarCut<double>.Tessellate([0, 0, 0, 50, 50, 00], null, 2);
    ...
    {
        var triangles = Logic.EarCut<float>.Tessellate([0, 0, 0, 50, 50, 00], null, 2);
        Assert.Equal([1, 0, 2], triangles);
    }
    
    [Fact]
    public void NotSoSimpleTriangleDouble() {
        var triangles = Logic.EarCut<double>.Tessellate([0, 0, 0, 25, 0, 50, 25, 25, 50, 0, 25, 0], null, 2);
    ...
    public void NotSoSimpleTriangleFloat() {
        var triangles = Logic.EarCut<float>.Tessellate([0, 0, 0, 25, 0, 50, 25, 25, 50, 0, 25, 0], null, 2);
        // Not optimal, but correct.
        Assert.Equal([ 1, 0, 5, 5, 4, 3, 3, 2, 1, 1, 5, 3 ], triangles);
    }
    ...
    {
        var triangles = Logic.EarCut<double>.Tessellate([0, 0, 10, 0, 10, 5, 5, 5, 5, 15, 0, 15], null, 2);
    ...
    {
        var triangles = Logic.EarCut<float>.Tessellate([0, 0, 10, 0, 10, 5, 5, 5, 5, 15, 0, 15], null, 2);
        Assert.Equal([4, 5, 0, 0, 1, 2, 3, 4, 0, 0, 2, 3], triangles);
    }
    ...
    {
        var triangles = Logic.EarCut<double>.Tessellate([10, 0, 0, 50, 60, 60, 70, 10], null, 2);
    ...
    {
        var triangles = Logic.EarCut<float>.Tessellate([10, 0, 0, 50, 60, 60, 70, 10], null, 2);
        Assert.Equal([1, 0, 3, 3, 2, 1], triangles);
    }
